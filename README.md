...
- Ganti ApiKey OpenAI pada file [openKey.json](https://github.com/sadxzyq/openAI/blob/3bd55740764bcb30084277f6be82d15b6ee25b99/key.json#L2)
...
```bash
$ git clone https://github.com/sadxzyq/openAI
$ cd Wa-OpenAI
$ npm install
$ node index.js
```
...
Copyright (c) 2022 M Yusril & Mr.Darkx
